...
<!--- WORKSHOP --->      
            	...
            	<label class="workshop">Which workshop(s) are you interested in:</label><br>
                    <h4 class="workshops">Workshop 1: Introduction to TFT <br> December 23, 2019</h4><input aria-label="workshop1" name="workshop1" type="radio" id="workshop1" class="workshop-date" checked="checked"> 
                    <h4 class="workshops">Workshop 2:  TFT Algorithm Training <br> December 23, 2019</h4><input aria-label="workshop2" name="workshop2" type="radio" id="workshop2"  class="workshop-date">			
